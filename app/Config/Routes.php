...
$routes->get('/dasbor/user', "App::listUser", ['filter' => 'adminOnly']);
$routes->get('/dasbor/user/enable/(:num)', "App::authorize/$1", ['filter' => 'adminOnly']);
$routes->get('/dasbor/user/disable/(:num)', "App::authorize/$1", ['filter' => 'adminOnly']);
